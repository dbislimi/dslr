...
from utils import COURSES, available_courses, convert_to_float, parse_data
...
def main(filepath: str) -> None:
    ...
    if not courses:
        ...
        sys.exit(1)
    data = convert_to_float(raw, courses, delete_none=True)
    if not data:
        print("Error: no usable numeric data after cleaning.")
        sys.exit(1)
    _describe(data)
